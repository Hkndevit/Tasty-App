  ...
  return (
    <section className="loading">
      <div className="loading__line">
        <svg width="186" height="99" viewBox="0 0 186 99" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="loading__logo">
        <svg width="27" height="17" viewBox="0 0 27 17" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            stroke-linecap="round"
          />
          <path d="M13.4011 10.6719V13.4748" stroke="white" stroke-width="2" stroke-linecap="round" />
          <path
      ...
      <div className="loading__line">
        <svg width="375" height="283" viewBox="0 0 375 283" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M449.514 327.169C462.083 284.964 461.374 192.234 405.163 156.94C348.953 121.647 289.808 124.497 216.474 163.743C142.356 203.41 47.165 199.838 64.211 131.425C87.429 38.2413 98.056 1.62099 32.4099 26.5024C-33.2362 51.3839 -6.44461 -9.73792 -80.5082 3.05578C-139.759 13.2907 -196.935 104.317 -251.649 2.22168"
            stroke="#3DA0A7"
          />
        </svg>
